...
esp_err_t cyd_display_get_touch_raw(int16_t *x, int16_t *y, bool *touched);
esp_err_t cyd_display_apply_touch_calibration(const uint16_t *params, size_t param_count);
esp_err_t cyd_display_calibrate_touch(uint16_t *params, size_t param_count);
